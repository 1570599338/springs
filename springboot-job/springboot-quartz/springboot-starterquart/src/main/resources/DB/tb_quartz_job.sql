...
-- ----------------------------
INSERT INTO `tb_quartz_job` VALUES ('22', 'shiro', 'shiro', '*/20 * * * * ?', 'com.lquan.layui.quartz.task.TestTask1', null, '0', 'a job a');
INSERT INTO `tb_quartz_job` VALUES ('23', 'test2', 'shiro', '*/30 * * * * ?', 'com.lquan.layui.quartz.task.TestTask2', null, '0', 'another job');
