...
public interface StatementMapper {
     ...
     * @return 对象列表
     */
    List<Statement> queryAllByLimit(Statement statement, @Param("pageable") Pageable pageable);
     ...
     *
     * @param entities List<Statement> 实例对象列表
     * @return 影响行数
     */
    int insertBatch(@Param("entities") List<Statement> entities);
     ...
     */
    int insertOrUpdateBatch(@Param("entities") List<Statement> entities);
