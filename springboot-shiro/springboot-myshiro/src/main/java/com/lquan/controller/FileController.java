...
import com.lquan.common.utils.file.FileUploadUtils;
import com.lquan.common.utils.file.FileUtils;
import com.lquan.config.ServerConfig;
...
public class FileController {
    ...
    public void resourceDownload(String resource, HttpServletRequest request, HttpServletResponse response)
            throws Exception {
        // 本地资源路径
        String localPath = Constants.profile;
        // 数据库资源地址
